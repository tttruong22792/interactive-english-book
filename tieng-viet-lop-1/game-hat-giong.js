...
const missions=[
  ...
  {id:'quick',title:'Cầu thử thách',short:'4 câu luyện nhanh',icon:'🎯',zone:'Cầu gỗ'},
  {id:'sentences',title:'Con đường câu chữ',short:'Đọc từng câu theo cụm nghĩa',icon:'⭐',zone:'Đường chữ'},
  {id:'full',title:'Ngôi nhà câu chuyện',short:'Đọc toàn bài 1–2 lượt',icon:'📖',zone:'Nhà truyện'},
